    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      <header className="sticky top-0 z-10 bg-white/80 backdrop-blur border-b border-neutral-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-semibold tracking-tight">Crematory.ai</h1>
          <div className="hidden md:block text-sm text-neutral-600">Accelerated memorial search, simple and affordable</div>
        </div>
      </header>
        ...
        <section className="mb-8 flex flex-col items-center justify-center text-center">
          <div className="bg-white border border-neutral-200 rounded-2xl p-6 max-w-3xl">
            ...
            <p className="mt-3 text-sm text-neutral-600">
              Try: rose gold urn necklace, biodegradable scatter urn, linen wrap for urn, cremation service near me.
            </p>
          </div>
        </section>
        ...
        <section className="mb-6">
          <div className="w-full flex flex-col items-center gap-3">
            <input
              ...
              className="w-full md:w-3/4 rounded-xl border border-neutral-300 bg-white px-5 py-4 text-base focus:outline-none focus:ring-2 focus:ring-neutral-900"
            />
          ...
          <p className="mt-3 text-sm text-neutral-600 text-center">
            Results update live. Click a card to visit the seller. Links may earn a commission.
          </p>
        </section>
...
window.CrematoryAI = CrematoryAI;
